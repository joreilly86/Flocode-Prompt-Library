...
```
Flocode-Prompt-Library/
├── core-prompts/           # Recursive generators (start here)
│   ├── prompt-generator.md
│   ├── context-engineering-framework.md
│   └── compact-and-continue.md
└── engineering/            # Domain-specific engineering assistants
    ├── engineering-ai-assistant.md
...
### [Compact and Continue](core-prompts/compact-and-continue.md)

**Purpose:** Context handoff utility for session transitions
Condenses lengthy conversations into focused handoff documents when approaching context limits

## Engineering Prompts

Pre-built assistants for common engineering needs:

- **[Professional Engineering AI Assistant](engineering/engineering-ai-assistant.md)** — Comprehensive PE-level support with code compliance
- **[Personal Engineering Assistant](engineering/personal-engineering-assistant.md)** — Python-focused technical support for individual engineers
...
1. **Choose your approach:**
   ...
   - Want immediate help? → Pick an [Engineering](engineering/) prompt

2. **Copy the prompt** into your AI tool (Claude, ChatGPT, Gemini, etc.)

3. **Customize** by replacing bracketed placeholders with your project specifics
...
Prompts reference applicable codes (ACI, ASCE, AISC, IBC, NEC, ASHRAE) and enforce verification protocols.
